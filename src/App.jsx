...
const App = () => {
   ...
   * @param {(string | null)} filter Current input at the moment of requesting a new page.
   * Value is null while user did not input anything at first.
   * The rest of the time, empty input is empty string.
   * @param {number} page Index of the new page to paginate the data for.
